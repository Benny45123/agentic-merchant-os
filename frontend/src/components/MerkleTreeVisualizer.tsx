    ...
    <div className="rounded-3xl bg-slate-900 text-white p-6 sm:p-8 border border-slate-800 shadow-xl overflow-hidden relative font-sans">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">
              Deterministic 3-leaf cryptographic audit trail with bit-for-bit zero-drift replayability.
            </p>
          </div>
        </div>
      ...
      <div className="relative z-10 space-y-8 max-w-4xl mx-auto">
        ...
        <div className="relative flex justify-center items-center h-8 -my-2 pointer-events-none">
          <svg className="w-full max-w-2xl h-8 overflow-visible" xmlns="http://www.w3.org/2000/svg">
            {/* Center vertical stem */}
            <line x1="50%" y1="0" x2="50%" y2="12" stroke="rgba(99, 102, 241, 0.6)" strokeWidth="2" strokeDasharray="3 3" />
            {/* Horizontal bar */}
            <line x1="18%" y1="12" x2="82%" y2="12" stroke="rgba(99, 102, 241, 0.6)" strokeWidth="2" />
            {/* Branch 1 Left */}
            <line x1="18%" y1="12" x2="18%" y2="32" stroke="rgba(99, 102, 241, 0.6)" strokeWidth="2" strokeDasharray="3 3" />
            {/* Branch 2 Center */}
            <line x1="50%" y1="12" x2="50%" y2="32" stroke="rgba(99, 102, 241, 0.6)" strokeWidth="2" strokeDasharray="3 3" />
            {/* Branch 3 Right */}
            <line x1="82%" y1="12" x2="82%" y2="32" stroke="rgba(99, 102, 241, 0.6)" strokeWidth="2" strokeDasharray="3 3" />
          </svg>
        </div>

        {/* Level 2: The 3 Cryptographic Leaves */}
